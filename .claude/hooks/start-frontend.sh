#!/usr/bin/env bash
# Starts the Angular dev server on port 4290 when a Claude Code session begins.
...
# Claude Code SessionStart hooks read additionalContext from this JSON shape.
emit_context() {
