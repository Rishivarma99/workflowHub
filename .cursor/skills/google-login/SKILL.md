...
Workflow Hub standard frontend port is **4290** (see `frontend-dev` skill). If the user runs port **4200**, Google Console must list `http://localhost:4200`. Mismatch between browser port and Console origins is the most common 403 cause.
